...
class PerformanceMetrics(BaseModel):
    ...
    request_latency_ms: float = Field(..., ge=0, description="Total request latency in milliseconds")
    llm_latency_ms: float = Field(..., ge=0, description="LLM API call latency in milliseconds")
